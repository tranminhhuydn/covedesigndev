...
public class Main extends ListActivity {
    ...
    int[][] buttonLed = {{1, 0, 0, 0}, {1, 1, 0, 1}, {1, 2, 0, 2}, {1, 3, 0, 3}};
    String[] buttonText = {"Trackball Light", "Button Light", "Green Light", "Red light", "Blink", "Background Light Blink"};
    String[] LED = {"jogball-backlight", "button-backlight", "green", "amber", "lcd-backlight"};
                            ...
                            if (cBox.isChecked()) {
                                switch (mo.id) {
                                    ...
                                    case (5):
                                        ...
                                        break;
                                    default:
                                        setLED(buttonLed[mo.id][0], buttonLed[mo.id][1]);
                                }
                            } else {
                                switch (mo.id) {
                                    case (4):
                                    ...
                                    case (5):
                                        ...
                                        break;
                                    default:
                                        setLED(buttonLed[mo.id][2], buttonLed[mo.id][3]);
                                }
                            }
